...
CREATE TABLE IF NOT EXISTS `<?php echo $table_prefix ?>contacts` (
  ...
  `display_name` varchar(50) <?php echo $default_collation ?> not NULL default '',
  `first_name` varchar(50) <?php echo $default_collation ?> not NULL default '',
  `middle_name` varchar(50) <?php echo $default_collation ?> not NULL default '',
  `last_name` varchar(50) <?php echo $default_collation ?> not NULL default '',
  ...
  `license_plate` varchar(50) <?php echo $default_collation ?> not NULL default '',
  `food_preferences` varchar(50) <?php echo $default_collation ?> not NULL default '',
  `department_details` varchar(50) <?php echo $default_collation ?> not NULL default '',
  `location_details` varchar(50) <?php echo $default_collation ?> not NULL default '',
  `language_preferences` varchar(50) <?php echo $default_collation ?> not NULL default '',
  `created_on` datetime NOT NULL default '0000-00-00 00:00:00',
  `created_by_id` int(10) unsigned default NULL,
  `updated_on` datetime NOT NULL default '0000-00-00 00:00:00',
  `updated_by_id` int(10) unsigned default NULL,
...
CREATE TABLE `<?php echo $table_prefix ?>users` (
  ...
  `locale` varchar(50) <?php echo $default_collation ?> NOT NULL default '',
  `created_on` datetime NOT NULL default '0000-00-00 00:00:00',
  `created_by_id` int(10) unsigned default NULL,
  `updated_on` datetime NOT NULL default '0000-00-00 00:00:00',
  `updated_by_id` int(10) unsigned default NULL,
