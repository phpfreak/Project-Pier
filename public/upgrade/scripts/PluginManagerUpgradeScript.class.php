<?php
  ...
  /**
  * Upgrade ProjectPier to support the Plugin Manager
  *
  * @package ScriptUpgrader.scripts
  * @http://www.projectpier.org/
  */
  class PluginManagerUpgradeScript extends ScriptUpgraderScript {
    ...
    */
    ...
    /**
    * Construct the PluginManagerUpgradeScript
    *
    * @param Output $output
    * @return PluginManagerUpgradeScript
    */
    ...
    */
    function execute() {
      ...
      $total_queries = 0;
      $executed_queries = 0;
      $upgrade_script = tpl_fetch(get_template_path('db_migration/plugin_manager'));
      ...
      $this->printMessage('ProjectPier has been patched for the plugin manager. Enjoy!');
    } // execute
    ...
    */
    function getScriptName() {
      return 'Upgrade of DB for Plugin Manager patch';
    } // getName
    
  
  } // PluginManagerUpgradeScript
