...
ALTER TABLE `{$tp}administration_tools` CHANGE `id` `id` int(10);
ALTER TABLE `{$tp}comments` CHANGE `rel_object_manager`  `rel_object_manager` varchar(50);
ALTER TABLE `{$tp}companies` CHANGE `client_of_id` `client_of_id` int(10);
ALTER TABLE `{$tp}companies` CHANGE `country`  `country` varchar(50);
ALTER TABLE `{$tp}companies` CHANGE `fax_number`  `fax_number` varchar(50);
ALTER TABLE `{$tp}companies` CHANGE `id` `id` int(10);
ALTER TABLE `{$tp}companies` CHANGE `logo_file`  `logo_file` varchar(50);
ALTER TABLE `{$tp}companies` CHANGE `phone_number`  `phone_number` varchar(50);
ALTER TABLE `{$tp}companies` CHANGE `fax_number`  `fax_number` varchar(50);
ALTER TABLE `{$tp}companies` CHANGE `timezone`  `timezone` float(4,2) default '0.00';
ALTER TABLE `{$tp}companies` CHANGE `zipcode`  `zipcode` varchar(50);
ALTER TABLE `{$tp}config_categories` CHANGE `id` `id` int(10);
ALTER TABLE `{$tp}config_options` CHANGE `category_name`  `category_name` varchar(50);
ALTER TABLE `{$tp}config_options` CHANGE `id` `id` int(10);
ALTER TABLE `{$tp}config_options` CHANGE `option_order` `option_order` tinyint(3);
...
ALTER TABLE `{$tp}file_types` CHANGE `id` `id` int(10);
ALTER TABLE `{$tp}im_types` CHANGE `icon`  `icon` varchar(50);
ALTER TABLE `{$tp}im_types` CHANGE `id` `id` int(10);
ALTER TABLE `{$tp}im_types` CHANGE `name`  `name` varchar(50);
...
ALTER TABLE `{$tp}project_companies` CHANGE `company_id` `company_id` int(10);
ALTER TABLE `{$tp}project_folders` CHANGE `id` `id` int(10);
ALTER TABLE `{$tp}project_forms` CHANGE `id` `id` int(10);
ALTER TABLE `{$tp}project_forms` CHANGE `order` `order` tinyint(3);
...
ALTER TABLE `{$tp}project_ticket_changes` CHANGE `id` `id` int(10);
ALTER TABLE `{$tp}project_ticket_changes` CHANGE `ticket_id` `ticket_id` int(10);
...
ALTER TABLE `{$tp}project_tickets` CHANGE `assigned_to_company_id` `assigned_to_company_id` int(10);
