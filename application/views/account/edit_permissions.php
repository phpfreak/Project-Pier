...
<!-- header -->
        <tr>
          ...
          <td class="center"><?php echo lang('details') ?></td>
          <td class="projectPermission center"><strong><?php echo lang('all') ?></strong></td>
<?php foreach ($permissions as $permission_name => $permission_text) { ?>
          <td class="projectPermission center"><?php echo clean($permission_text) ?></td>
<?php } // foreach ?>
        </tr>
<!-- projects -->
...
<?php } // if ?>
          <td class="projectPermission center"><a href="<?php echo $user->getEditProjectPermissionsUrl($project) ?>"><?php echo lang('edit') ?></a></td>
