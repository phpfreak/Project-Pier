<?php
  ...
  trace(__FILE__, 'get_url');
?>

      <form action="<?php echo htmlentities(get_url('access', 'login')); ?>" method="post">
        ...
        <div class="container">
          ...
          <div class="left">
            ...
            <?php if ($login_show_options) : ?> 
              <div id="loginOptionsLink">
                <label for="showOptionsLink">
                  <a id="showOptionsLink" href="javascript:showOptions()"><?php echo lang('options'); ?></a>
                  <a id="hideOptionsLink" class="hidden" href="javascript:hideOptions()"><?php echo lang('hide options'); ?></a>
                </label>
              </div>
...
<?php endif; ?>
<?php
  add_inline_javascript_to_page('document.forms[0].loginUsername.focus();');
  trace(__FILE__, 'end');