  ...
  abstract class BaseProjectTimes extends DataManager {
    ...
    */
    function __construct() {
      parent::__construct('ProjectTime', 'project_times', true);
    } // __construct
